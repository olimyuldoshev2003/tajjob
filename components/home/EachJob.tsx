  ...
  return (
    ...
    >
      <View style={dynamicStyles.headerContainerBlock}>
        ...
        <FontAwesome name="bookmark-o" size={36} color={colorScheme === "dark" ? "#fff" : "#000000"} />
      </View>
      <View style={dynamicStyles.locationContainerBlock}>
        <Entypo name="location-pin" size={29} color={colorScheme === "dark" ? "#fff" : "#000000"} />
        <Text style={dynamicStyles.location}>{job.location}</Text>
      </View>
      <View style={dynamicStyles.employmentTypeWorkingModelAndJobLevelContainerBlock}>
      ...
      <View style={dynamicStyles.appliersAndSalaryContainerBlock}>
        <View style={dynamicStyles.someAppliersImgsAndAppliersAmount}>
          ...
          <Text style={dynamicStyles.aplliersAmount}>{job.appliers} Appliers</Text>
        </View>
